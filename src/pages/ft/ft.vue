...
<!--            <span style="font-size: 28rpx;margin-left: 14rpx" class="base_word">公开联系方式</span>-->
<!--            <van-switch-->
<!--              size="50rpx"-->
...
<!--              &lt;!&ndash; <i class="iconfont icon-quanping"></i> &ndash;&gt;-->
  ...
  export default {
    ...
    methods: {
      ...
      changeOpenStatus() {
        ...
        let msg = this.isOpenWechat ? "联系方式被公开" : "联系方式不公开"
        Toast.fail(msg);
      },
      changeIsSercet() {
